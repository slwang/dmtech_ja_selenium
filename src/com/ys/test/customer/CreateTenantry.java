...
public class CreateTenantry extends YSTestBase{
	...
	public void test_createProject() throws InterruptedException {
       ...
       //企业基本信息
		...
		name.clear();
		tenantryName = "承租方"+DateUtil.getDateFormatHour();
		...
		website.clear();
		website.sendKeys("http://www.baido.com");
		
		Select buttmanSel = new Select(driver.findElement(By.id("buttman")));
		buttmanSel.selectByIndex(1);
		...
		WebElement branchNum = driver.findElement(By.id("branchNum"));
		branchNum.clear();
		branchNum.sendKeys("1000021");
		
		WebElement branchNum1 = driver.findElement(By.id("branchNum1"));
		branchNum1.clear();
		branchNum1.sendKeys("1000022");
