...
public class CreateGuarantors extends YSTestBase{
	...
	public void test_createProject() throws InterruptedException {
		...
		WebElement proManager = driver.findElement(By.linkText("资金方(授权)"));
		proManager.click();

		driver.switchTo().defaultContent();
		driver.switchTo().frame("rightFrame");
		driver.switchTo().frame("frame_tab_50204");
		...
		name.clear();
		String fundName = "担保方"+DateUtil.getDateFormatHour();
