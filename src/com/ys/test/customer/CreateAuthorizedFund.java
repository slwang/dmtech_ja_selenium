...
public class CreateAuthorizedFund extends YSTestBase{
	...
	public void test_createProject() throws InterruptedException {
		...
		WebElement proManager = driver.findElement(By.linkText("担保机构管理"));
		proManager.click();

		driver.switchTo().defaultContent();
		driver.switchTo().frame("rightFrame");
		driver.switchTo().frame("frame_tab_50205");
		...
		name.clear();
		String guarantorsName = "授权资金方"+DateUtil.getDateFormatHour();
		name.sendKeys(guarantorsName);

		WebElement shortName = driver.findElement(By.id("shortName"));
		shortName.clear();
		shortName.sendKeys(guarantorsName+"简称");
		...
		remarkers.clear();
		remarkers.sendKeys(guarantorsName + "企业备注信息");
