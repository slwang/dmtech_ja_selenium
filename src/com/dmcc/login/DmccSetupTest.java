...
public class DmccSetupTest {
	...
	private static String businessName = "test";
	private static String productNumber = "";
	private static String productName = "test";
	private static String workflowName = "test工作流";
	...
	@Test
	public void test_001_createBusiness() throws InterruptedException{
	...
	@Test
	public void test_002_createProduct() throws InterruptedException{
		...
		/*WebElement businessNameWe = driver.findElement(By.id("businessNumber"));
		businessNameWe.clear();
		businessNameWe.sendKeys(businessName);//自动带出*/
	...
	@Test
	public void test_003_creatRolePage() throws InterruptedException{
	...
	@Test
	public void test_004_createWf() throws InterruptedException{
	...
	@Test
	public void test_005_createNodeList() throws InterruptedException{
		Thread.sleep(1000);
	...
	@Test
	public void test_006_releaseWorkFlow() throws InterruptedException{
		Thread.sleep(1000);
		driver.get(basePath + wfUrl);
		Thread.sleep(1000);
		WebElement workflowNameWe = driver.findElement(By.id("workflowName"));
